...
function rabbitmq.config_settings {
  waffles.subtitle "rabbitmq.config_settings"
  ...
  waffles.options.create_option auth_backends
  waffles.options.create_option auth_mechanisms
  waffles.options.create_option backing_queue_module
  waffles.options.create_option cluster_partition_handling
  waffles.options.create_option collect_statistics
  waffles.options.create_option collect_statistics_interval
  waffles.options.create_option default_permissions
  waffles.options.create_option default_user
  waffles.options.create_option default_user_tags
  waffles.options.create_option default_vhost
  waffles.options.create_option delegate_count
  waffles.options.create_option disk_free_limit_type
  waffles.options.create_option disk_free_limit_value
  waffles.options.create_option frame_max
  waffles.options.create_option heartbeat
  waffles.options.create_option hipe_compile
  waffles.options.create_option log_levels
  waffles.options.create_option msg_store_file_size_limit
  waffles.options.create_option msg_store_index_module
  waffles.options.create_option queue_index_max_journal_entries
  waffles.options.create_option tcp_listener_address
  waffles.options.create_option tcp_listener_port
  waffles.options.create_option vm_memory_high_watermark
  waffles.options.create_option ssl_listener_address
  waffles.options.create_option ssl_listener_port
  waffles.options.create_option ssl_ssl_keyfile
  waffles.options.create_option ssl_certfile
  waffles.options.create_option ssl_cacertfile
  waffles.options.create_option ssl_verify
waffles.options.parse_options "$@"
  ...
  if [[ -n "${options[default_permissions]}" ]]; then
    string.split "${options[default_permissions]}" ","
    if [[ $(array.length __split) == 3 ]]; then
  ...
  if [[ -n "${options[log_levels]}" ]]; then
    local _category
    local _level
    string.split "${options[log_levels]}" ","
    for l in "${__split[@]}"; do
      _category="${l%=*}"
      _level="${l##*=}"
