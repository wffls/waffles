...
function rabbitmq.user_permissions {
  waffles.subtitle "rabbitmq.user_permissions"
  ...
  waffles.catalog.add "rabbitmq.user_permissions/${options[user]}"
  ...
  waffles.resource.process "rabbitmq.user_permissions" "${options[user]}"
}
