...
source "$WAFFLES_DIR/lib/stdlib/resources/symlink.sh"
...
function stdlib.enable_augeas {
  stdlib.warn "stdlib.enable_augeas is no longer required."
}
...
function stdlib.enable_mysql {
  stdlib.warn "stdlib.enable_mysql is no longer required."
}
...
function stdlib.enable_rabbitmq {
  stdlib.warn "stdlib.enable_rabbitmq is no longer required."
}
...
function stdlib.enable_nginx {
  stdlib.warn "stdlib.enable_nginx is no longer required."
}
...
function stdlib.enable_apache {
  stdlib.warn "stdlib.enable_apache is no longer required."
}
...
function stdlib.enable_keepalived {
  stdlib.warn "stdlib.enable_keepalived is no longer required."
}
...
function stdlib.enable_consul {
  stdlib.warn "stdlib.enable_consul is no longer required."
}
...
function stdlib.enable_python {
  stdlib.warn "stdlib.enable_python is no longer required."
}
